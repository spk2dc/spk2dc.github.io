...
<div class="row">
  ...
  <div class="col-lg-12">
    <div class="thumbnail">
      <div class="image">
        <a href="{{site.baseurl}}/assets/img/projects/SpotifyFilter/SpotifyFilter (5).png"><img src="{{site.baseurl}}/assets/img/projects/SpotifyFilter/SpotifyFilter (5).png" class="img-responsive" alt="Cerulean"></a>
      </div>
      <div class="caption">
        <h3>Landing Page</h3>
  ...
  <div class="col-lg-12">
    <div class="thumbnail">
      <div class="image">
        <a href="{{site.baseurl}}/assets/img/projects/SpotifyFilter/SpotifyFilter (4).png"><img src="{{site.baseurl}}/assets/img/projects/SpotifyFilter/SpotifyFilter (4).png" class="img-responsive" alt="Cerulean"></a>
      </div>
      <div class="caption">
  ...
  <div class="col-lg-12">
    <div class="thumbnail">
      <div class="image">
        <a href="{{site.baseurl}}/assets/img/projects/SpotifyFilter/SpotifyFilter (2).png"><img src="{{site.baseurl}}/assets/img/projects/SpotifyFilter/SpotifyFilter (2).png" class="img-responsive" alt="Cerulean"></a>
      </div>
      <div class="caption">
  ...
  <div class="col-lg-12">
    <div class="thumbnail">
      <div class="image">
        <a href="{{site.baseurl}}/assets/img/projects/SpotifyFilter/SpotifyFilter (3).png"><img src="{{site.baseurl}}/assets/img/projects/SpotifyFilter/SpotifyFilter (3).png" class="img-responsive" alt="Cerulean"></a>
      </div>
      <div class="caption">
